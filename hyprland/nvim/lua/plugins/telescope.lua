local function find_files_at(cwd)
...
return {
  ...
  keys = {
    ...
    { "<leader>fc", LazyVim.pick.config_files(), desc = "Find Config File" },
    {
      ...
      desc = "Find Files (Root Dir, incl. gitignored, show .gitignore)",
    },
    {
      "<leader>fF",
      function()
      ...
      desc = "Find Files (Current File Dir, incl. gitignored)",
    },
  ...
  opts = function()
    ...
    local function find_command()
      if 1 == vim.fn.executable("rg") then
        return { "rg", "--files", "--hidden", "--no-ignore", "--no-ignore-parent", "--color", "never", "-g", "!.git" }
      elseif 1 == vim.fn.executable("fd") then
        return { "fd", "--type", "f", "--hidden", "--no-ignore", "--color", "never", "-E", ".git" }
      elseif 1 == vim.fn.executable("fdfind") then
        return { "fdfind", "--type", "f", "--hidden", "--no-ignore", "--color", "never", "-E", ".git" }
