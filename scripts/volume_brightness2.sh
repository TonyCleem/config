...
screen_brightness_step=10
max_volume=100
notification_timeout=1000

# Specify Icon Theme here:
volume_theme_icon="audio-volume-high-symbolic"
screen_brightness_theme_icon="display-brightness-symbolic"
keyboard_brightness_theme_icon="display-brightness-symbolic"
